...
public static class LoggerConfigurationEmailExtensions
{
        ...
        string mailSubject = EmailConnectionInfo.DefaultSubject)
    {
        ...
        var batchingSink = new PeriodicBatchingSink(new EmailSink(connectionInfo, textFormatter, mailSubjectFormatter, transport), batchingOptions);
        ...
        string mailSubject = EmailConnectionInfo.DefaultSubject)
    {
        ...
        ITextFormatter mailSubjectFormatter = new MessageTemplateTextFormatter(mailSubject, formatProvider);
